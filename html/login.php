...
if (isset($_POST['login'])) {
	...
	if ($_SESSION['attempt'] == 3) {
		...
		$stmt = $pdo->prepare('SELECT username, FirstName, password FROM Employee WHERE username = :username');
...
<div class="login content-wrapper">
			...
			<a href="index.php?page=user_login">Not an employee? Click here for User login</a>
		</div>
<?=template_footer()?>
